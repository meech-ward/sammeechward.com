            ...
            <div className="relative flex h-16 items-center justify-between">
              <div className="flex items-center px-2 lg:px-0">
                <div className="flex-shrink-0">
                  <Link href="/"><a><h1 className="block h-8 w-auto lg:hidden text-white text-2xl">saM</h1></a></Link>
                  <Link href="/"><a><h1 className="hidden h-8 w-auto lg:block text-white text-2xl">saM</h1></a></Link>
                </div>
