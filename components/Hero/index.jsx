    ...
    <div className="relative overflow-hidden bg-white">
      <div className="mx-auto max-w-7xl px-2">
        <div className="relative z-10 bg-white pb-4 sm:pb-8 md:pb-10 lg:w-2/4 lg:max-w-2xl lg:pb-14 xl:pb-16">
          ...
          <div className="mx-auto mt-10 max-w-7xl px-2 px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
              ...
              {icons &&
                ...
                <div className="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
                  <div className="mt-8 flex">
                    {icons.facebook &&
                      <a target="_blank" href={icons.facebook} className="text-gray-400 hover:text-gray-500">
                    ...
                    {icons.instagram &&
                      <a target="_blank" href={icons.instagram} className="ml-6 text-gray-400 hover:text-gray-500">
                    ...
                    {icons.twitter &&
                      <a target="_blank" href={icons.twitter} className="ml-6 text-gray-400 hover:text-gray-500">
                    ...
                    {icons.github &&
                      <a target="_blank" href={icons.github} className="ml-6 text-gray-400 hover:text-gray-500">
                    ...
                    {icons.linkedin &&
                      <a target="_blank" href={icons.linkedin} className="ml-6 text-gray-400 hover:text-gray-500">
                    ...
                    {icons.youtube &&
                      <a target="_blank" href={icons.youtube} className="ml-6 text-gray-400 hover:text-gray-500">
